...
use crate::tables::{CENTROID, EDGES, JUNCTION_FACES, SUBVOXEL};
...
///
/// Takes the same 12-bit crossing mask as [`cell_vertex`], so a cell is
/// classified from a value the extractor has already computed rather than from
/// a second pass over its corners.
#[inline]
pub fn is_edge_vertex(crossings: u16) -> bool {
    JUNCTION_FACES[crossings as usize] != 0
}
